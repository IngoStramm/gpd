...
- Gestão por Desempenho (Nome do plugin)
- gpd (nome dos arquivos, nome do text domain e slug da url do repositório)
- GPD_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- gpd_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Gestão por Desempenho, através do próprio sistema de atualizações do WordPress
